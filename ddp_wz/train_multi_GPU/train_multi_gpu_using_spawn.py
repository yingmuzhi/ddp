...
def main_fun(rank, world_size, args):
    ...
    if rank == 0:  # 在第一个进程中打印信息，并实例化tensorboard
        ...
        if os.path.exists("/home/yingmuzhi/_learning/src/weights/ddp_weights") is False:
            os.makedirs("/home/yingmuzhi/_learning/src/weights/ddp_weights")
    ...
    if os.path.exists(weights_path):
        ...
        checkpoint_path = "/home/yingmuzhi/_learning/src/weights/ddp_weights/initial_weights.pt"
