...
def parse_args():
    ...
    parser.add_argument("--data_path",
        default="/home/yingmuzhi/microDL_3_0/src/data/output/flower_photos",
    )
...
def run_ddp(rank, world_size, dist_url, dist_backend, device_str):
    ...
    resnet_trainer = trainer.abstract_trainer_v2.AbstractTrainer(
        nn_module="resnet",
    ...
    if os.path.exists(args.checkpoint_path):
        ...
        resnet_trainer =  trainer.abstract_trainer_v2.AbstractTrainer.load_state_from_yingmuzhi(
        ...
        if rank == 0:
            ...
            resnet_trainer.save_state(save_path=args.checkpoint_path)
        ...
        world_size = trainer.multi_train_utils.distributed_utils.dist.get_world_size()
        gpu_ids = [gpu_id for _ in range(world_size)]
        resnet_trainer = trainer.abstract_trainer_v2.AbstractTrainer.load_state_from_yingmuzhi(load_path=args.checkpoint_path, gpu_ids=gpu_ids, load_checkpoint_on_cpu=False, total_epoch=args.total_epoch, loss_str="CrossEntropyLoss")
